 ...
 * @opensearch.internal
 */
public class GenerationTransferException extends RuntimeException {

    private final TranslogCheckpointSnapshot fileSnapshot;

    public GenerationTransferException(TranslogCheckpointSnapshot fileSnapshot, Throwable cause) {
        super(cause);
