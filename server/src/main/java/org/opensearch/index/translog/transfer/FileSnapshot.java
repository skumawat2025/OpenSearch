...
public class FileSnapshot implements Closeable {
    ...
    public static final class TranslogFileSnapshot extends TransferFileSnapshot {
        ...
        public final static String CHECKPINT_FILE_CHECKSUM_KEY = "ckp-checksum";
        ...
        public TranslogFileSnapshot(long primaryTerm, long generation, Path path, Long checksum, Path checkpointPath, Long checkpointChecksum) throws IOException {
            super(path, primaryTerm, checksum);
            this.generation = generation;
